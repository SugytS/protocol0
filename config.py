...
# ЭКОНОМИКА И ЦЕНЫ
# Базовые цены улучшений (ТОЛЬКО ДВА ТИПА)
UPGRADE_BASE_PRICES = {
    "damage": 100,      # Множитель урона
    "speed": 120,       # Скорость движения
}

# Множитель цены за каждую покупку того же типа улучшения
UPGRADE_PRICE_MULTIPLIER = 1.5

# Бонус монет за уровень
LEVEL_COIN_BONUS = 200

# Штраф за смерть
DEATH_COIN_PENALTY = 0.3  # 30% от накопленных монет теряется при смерти
